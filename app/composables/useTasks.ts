...
export function useTasks() {
  ...
  async function createTask(data: Partial<Task>): Promise<Task> {
    ...
    if (isApiConnected.value) {
      try {
        ...
        console.warn('Failed to create task via API, using local:', err)
      }
    }
  ...
  async function updateTask(id: string, data: Partial<Task>) {
    ...
    if (isApiConnected.value) {
      try {
        ...
        console.warn('Failed to update task via API, using local:', err)
      }
    }
  ...
  async function deleteTask(id: string) {
    if (isApiConnected.value) {
      try {
        ...
        console.warn('Failed to delete task via API, using local:', err)
      }
    }
  ...
  function setFilter(key: keyof TaskFilters, value: any) {
