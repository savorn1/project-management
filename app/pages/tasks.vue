                ...
                <div class="flex flex-wrap items-center gap-2">
                  <div class="relative">
                    <select
                      ...
                      class="appearance-none pl-3 pr-7 py-1.5 rounded-full text-xs font-semibold cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-offset-slate-900 transition-all duration-200"
                    ...
                    <svg class="absolute right-2 top-1/2 -translate-y-1/2 w-3 h-3 pointer-events-none opacity-60" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="bg-slate-800/40 rounded-xl border border-slate-700/30 divide-y divide-slate-700/30">
                  ...
                  <div class="flex items-center gap-3 px-4 py-3">
                    ...
                    <input
                      ...
                      class="flex-1 bg-transparent text-sm text-gray-300 hover:text-white focus:outline-none cursor-pointer transition-colors"
                    />
                  </div>
